...
@section('page-title', 'Créer un atelier')
    ...
    <div class="bg-white rounded-xl border border-beige-200/60 p-6 sm:p-8">
        ...
        <div class="flex items-center gap-3 mb-6 pb-5 border-b border-beige-100">
            <div class="w-10 h-10 rounded-lg bg-brand-50 flex items-center justify-center">
                <svg class="w-5 h-5 text-brand-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                    <line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" />
                </svg>
            </div>
            <div>
                <h2 class="text-lg font-bold text-dark">Nouvel atelier</h2>
                <p class="text-[12px] text-beige-400">Remplissez les informations de l'atelier</p>
            </div>
        </div>

        <form action="{{ route('admin.ateliers.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="titre" name="titre" value="{{ old('titre') }}" required placeholder="Ex: Jollof Rice Sénégalais"
                ...
                <div>
                    ...
                    <input type="text" id="plat" name="plat" value="{{ old('plat') }}" required placeholder="Ex: Jollof Rice"
                        class="w-full px-4 py-2.5 rounded-lg border border-beige-300 bg-white text-sm text-dark placeholder:text-beige-400 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/10 transition duration-200">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4" required placeholder="Décrivez l'atelier en détail..."
                    class="w-full px-4 py-2.5 rounded-lg border border-beige-300 bg-white text-sm text-dark placeholder:text-beige-400 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/10 transition duration-200 resize-none">{{ old('description') }}</textarea>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="origine_pays" name="origine_pays" value="{{ old('origine_pays') }}" required placeholder="Ex: Sénégal"
                        class="w-full px-4 py-2.5 rounded-lg border border-beige-300 bg-white text-sm text-dark placeholder:text-beige-400 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/10 transition duration-200">
                ...
                <div>
                    ...
                    <input type="number" id="prix" name="prix" value="{{ old('prix') }}" required min="0" placeholder="Ex: 15000"
                        class="w-full px-4 py-2.5 rounded-lg border border-beige-300 bg-white text-sm text-dark placeholder:text-beige-400 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/10 transition duration-200">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" id="duree_minutes" name="duree_minutes" value="{{ old('duree_minutes') }}" required min="30" placeholder="Ex: 120"
                        class="w-full px-4 py-2.5 rounded-lg border border-beige-300 bg-white text-sm text-dark placeholder:text-beige-400 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/10 transition duration-200">
                ...
                <div>
                    ...
                    <input type="number" id="max_participants" name="max_participants" value="{{ old('max_participants', 6) }}" required min="2" max="20"
                        class="w-full px-4 py-2.5 rounded-lg border border-beige-300 bg-white text-sm text-dark placeholder:text-beige-400 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/10 transition duration-200">
